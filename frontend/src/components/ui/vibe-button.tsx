        ...
        return (
            ...
            >
                ...
                <Button
                    ...
                    className={cn(
                        "relative",
                        variant === "default" && "bg-gradient-to-r from-primary to-brand-600 hover:from-primary/90 hover:to-brand-600/90 shadow-[0_0_20px_rgba(139,92,246,0.3)] border-0 text-primary-foreground",
