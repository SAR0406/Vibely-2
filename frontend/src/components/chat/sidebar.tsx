...
export function Sidebar({ isCollapsed }: SidebarProps) {
    ...
    return (
        <motion.aside
            layout
            className="flex h-full flex-col bg-transparent w-full relative z-30 overflow-hidden"
        >
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="relative group">
                            ...
                            <input
                                ...
                                placeholder="Search..."
                                className="w-full h-11 pl-11 pr-4 text-sm font-medium rounded-xl bg-white/5 border border-white/5 outline-none focus:border-indigo-500/30 focus:bg-white/10 transition-all placeholder:text-zinc-600 shadow-inner"
                            />
                        </div>
                        ...
                        <div className="flex bg-black/20 rounded-xl p-1 border border-white/5">
                            {(["chats", "friends"] as SidebarTab[]).map(tab => (
                                <button
                                    ...
                                    className={cn(
                                        "flex-1 text-[11px] uppercase tracking-wide font-bold py-2 rounded-lg transition-all duration-300",
                                        activeTab === tab
            ...
            {/* FOOTER - Profile Zone */}
            {!isCollapsed && (
                <div className="p-5 shrink-0 relative z-10 border-t border-white/5 bg-black/20 backdrop-blur-xl">
